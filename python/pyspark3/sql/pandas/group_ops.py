...
class PandasGroupedOpsMixin(object):
    ...
    def applyInPandas(self, func, schema):
        ...
        >>> from pyspark3.sql.functions import pandas_udf, ceil
        >>> df = spark.createDataFrame(
        ...     [(1, 1.0), (1, 2.0), (2, 3.0), (2, 5.0), (2, 10.0)],
        ...     ("id", "v"))  # doctest: +SKIP
        >>> def normalize(pdf):
        ...
        pyspark.sql.functions.pandas_udf
        """
        from pyspark3.sql import GroupedData
        from pyspark3.sql.functions import pandas_udf, PandasUDFType
...
class PandasCogroupedOps(object):
    ...
    def applyInPandas(self, func, schema):
        ...
        pyspark.sql.functions.pandas_udf
        """
        from pyspark3.sql.pandas.functions import pandas_udf
...
def _test():
    ...
    import pyspark3.sql.pandas.group_ops
