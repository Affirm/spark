...
from pyspark3 import since, keyword_only
from pyspark3.sql.column import _to_seq
from pyspark3.sql.readwriter import OptionUtils, to_str
from pyspark3.sql.types import StructType, StructField, StringType
from pyspark3.sql.utils import ForeachBatchFunction, StreamingQueryException
...
class DataStreamWriter(object):
    ...
    def _sq(self, jsq):
        from pyspark3.sql.streaming import StreamingQuery
    ...
    def foreach(self, f):
        ...
        from pyspark3.rdd import _wrap_function
        from pyspark3.serializers import PickleSerializer, AutoBatchedSerializer
    ...
    def foreachBatch(self, func):
        ...
        from pyspark3.java_gateway import ensure_callback_server_started
...
def _test():
    ...
    import os
    import tempfile
    from pyspark3.sql import SparkSession, SQLContext
    import pyspark3.sql.streaming
