...
from pyspark3.sql.pandas.group_ops import PandasGroupedOpsMixin
from pyspark3.sql.types import StructType, StructField, IntegerType, StringType
...
class GroupedData(PandasGroupedOpsMixin):
    ...
    def agg(self, *exprs):
        ...
        >>> from pyspark3.sql.functions import pandas_udf, PandasUDFType
