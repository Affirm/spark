...
from pyspark3 import copy_func
from pyspark3.context import SparkContext
from pyspark3.sql.types import DataType, StructField, StructType, IntegerType, StringType
...
class Column(object):
    ...
    def over(self, window):
        ...
        >>> from pyspark3.sql.functions import rank, min
        ...
        +---+-----+----+---+
        """
        from pyspark3.sql.window import WindowSpec
