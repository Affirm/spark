...
from pyspark3 import copy_func, since, _NoValue
from pyspark3.rdd import RDD, _load_from_socket, _local_iterator_from_socket
from pyspark3.serializers import BatchedSerializer, PickleSerializer, \
    UTF8Deserializer
from pyspark3.storagelevel import StorageLevel
from pyspark3.traceback_utils import SCCallSiteSync
from pyspark3.sql.types import _parse_datatype_json_string
from pyspark3.sql.column import Column, _to_seq, _to_list, _to_java_column
from pyspark3.sql.readwriter import DataFrameWriter, DataFrameWriterV2
from pyspark3.sql.streaming import DataStreamWriter
from pyspark3.sql.types import StructType, StructField, StringType, IntegerType
from pyspark3.sql.pandas.conversion import PandasConversionMixin
from pyspark3.sql.pandas.map_ops import PandasMapOpsMixin
...
class DataFrame(PandasMapOpsMixin, PandasConversionMixin):
    ...
    def withWatermark(self, eventTime, delayThreshold):
        ...
        >>> from pyspark3.sql.functions import timestamp_seconds
        >>> sdf.select(
        ...    'name',
    ...
    def sampleBy(self, col, fractions, seed=None):
        ...
        Examples
        --------
        >>> from pyspark3.sql.functions import col
    ...
    def alias(self, alias):
        ...
        Examples
        --------
        >>> from pyspark3.sql.functions import *
    ...
    def join(self, other, on=None, how=None):
        ...
        >>> from pyspark3.sql.functions import desc
    ...
    def agg(self, *exprs):
        ...
        [Row(max(age)=5)]
        >>> from pyspark3.sql import functions as F
...
def _test():
    import doctest
    from pyspark3.context import SparkContext
    from pyspark3.sql import Row, SQLContext, SparkSession
    import pyspark3.sql.dataframe
