...
from pyspark3.sql import Column, Row
from pyspark3.sql.types import StructType, StructField, LongType
...
class ColumnTests(ReusedSQLTestCase):
    ...
    def test_validate_column_types(self):
        from pyspark3.sql.functions import udf, to_json
        from pyspark3.sql.column import _to_java_column
...
if __name__ == "__main__":
    import unittest
    from pyspark3.sql.tests.test_column import *  # noqa: F401
