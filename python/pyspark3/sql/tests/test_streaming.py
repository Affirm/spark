...
class StreamingTests(ReusedSQLTestCase):
    ...
    def test_stream_status_and_progress(self):
        ...
        from pyspark3.sql.functions import col, udf
        sleep_udf = udf(func)
    ...
    def test_stream_exception(self):
        ...
        from pyspark3.sql.functions import col, udf
        from pyspark3.sql.utils import StreamingQueryException
...
if __name__ == "__main__":
    import unittest
    from pyspark3.sql.tests.test_streaming import *  # noqa: F401
