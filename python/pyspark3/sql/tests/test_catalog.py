...
from pyspark3.sql.types import StructType, StructField, IntegerType
...
class CatalogTests(ReusedSQLTestCase):
    ...
    def test_list_tables(self):
        from pyspark3.sql.catalog import Table
        spark = self.spark
        with self.database("some_db"):
            spark.sql("CREATE DATABASE some_db")
    ...
    def test_list_functions(self):
        from pyspark3.sql.catalog import Function
        spark = self.spark
        with self.database("some_db"):
            spark.sql("CREATE DATABASE some_db")
    ...
    def test_list_columns(self):
        from pyspark3.sql.catalog import Column
        spark = self.spark
        with self.database("some_db"):
            spark.sql("CREATE DATABASE some_db")
...
if __name__ == "__main__":
    import unittest
    from pyspark3.sql.tests.test_catalog import *  # noqa: F401
