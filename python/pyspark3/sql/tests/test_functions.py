...
from pyspark3.sql import Row, Window
from pyspark3.sql.functions import udf, input_file_name, col, percentile_approx, lit
from pyspark3.testing.sqlutils import ReusedSQLTestCase


class FunctionsTests(ReusedSQLTestCase):

    def test_explode(self):
        from pyspark3.sql.functions import explode, explode_outer, posexplode_outer
        d = [
    ...
    def test_math_functions(self):
        df = self.sc.parallelize([Row(a=i, b=2 * i) for i in range(10)]).toDF()
        from pyspark3.sql import functions
        import math
    ...
    def test_string_functions(self):
        from pyspark3.sql import functions
        from pyspark3.sql.functions import col, lit
        string_functions = [
            "upper", "lower", "ascii",
            "base64", "unbase64",
            "ltrim", "rtrim", "trim"
    ...
    def test_array_contains_function(self):
        from pyspark3.sql.functions import array_contains
    ...
    def test_dayofweek(self):
        from pyspark3.sql.functions import dayofweek
    ...
    def test_functions_broadcast(self):
        from pyspark3.sql.functions import broadcast
    ...
    def test_slice(self):
        from pyspark3.sql.functions import lit, size, slice
    ...
    def test_array_repeat(self):
        from pyspark3.sql.functions import array_repeat, lit
    ...
    def test_overlay(self):
        from pyspark3.sql.functions import col, lit, overlay
        from itertools import chain
        import re
    ...
    def test_nth_value(self):
        from pyspark3.sql import Window
        from pyspark3.sql.functions import nth_value
    ...
    def test_higher_order_function_failures(self):
        from pyspark3.sql.functions import col, transform
    ...
    def test_nested_higher_order_function(self):
        ...
        from pyspark3.sql.functions import flatten, struct, transform
    ...
    def test_assert_true(self):
        from pyspark3.sql.functions import assert_true
    ...
    def test_raise_error(self):
        from pyspark3.sql.functions import raise_error
...
if __name__ == "__main__":
    import unittest
    from pyspark3.sql.tests.test_functions import *  # noqa: F401
