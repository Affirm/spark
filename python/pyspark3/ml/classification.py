...
from pyspark3 import keyword_only, since, SparkContext
from pyspark3.ml import Estimator, Predictor, PredictionModel, Model
from pyspark3.ml.param.shared import HasRawPredictionCol, HasProbabilityCol, HasThresholds, \
...
from pyspark3.ml.tree import _DecisionTreeModel, _DecisionTreeParams, \
    _TreeEnsembleModel, _RandomForestParams, _GBTParams, \
    _HasVarianceImpurity, _TreeClassifierParams
from pyspark3.ml.regression import _FactorizationMachinesParams, DecisionTreeRegressionModel
from pyspark3.ml.base import _PredictorParams
from pyspark3.ml.util import DefaultParamsReader, DefaultParamsWriter, \
    JavaMLReadable, JavaMLReader, JavaMLWritable, JavaMLWriter, \
    MLReader, MLReadable, MLWriter, MLWritable, HasTrainingSummary
from pyspark3.ml.wrapper import JavaParams, \
    JavaPredictor, JavaPredictionModel, JavaWrapper
from pyspark3.ml.common import inherit_doc
from pyspark3.ml.linalg import Vectors, VectorUDT
from pyspark3.sql import DataFrame
from pyspark3.sql.functions import udf, when
from pyspark3.sql.types import ArrayType, DoubleType
...
class LinearSVC(_JavaClassifier, _LinearSVCParams, JavaMLWritable, JavaMLReadable):
    ...
    >>> from pyspark3.ml.linalg import Vectors
    >>> df = sc.parallelize([
...
class DecisionTreeClassifier(_JavaProbabilisticClassifier, _DecisionTreeClassifierParams,
    ...
    --------
    >>> from pyspark3.ml.linalg import Vectors
    >>> from pyspark3.ml.feature import StringIndexer
...
class FMClassifier(_JavaProbabilisticClassifier, _FactorizationMachinesParams, JavaMLWritable,
    ...
    * adamW (default)
    ...
    --------
    >>> from pyspark3.ml.linalg import Vectors
    >>> from pyspark3.ml.classification import FMClassifier
    >>> df = spark.createDataFrame([
    ...     (1.0, Vectors.dense(1.0)),
    ...     (0.0, Vectors.sparse(1, [], []))], ["label", "features"])
...
if __name__ == "__main__":
    import doctest
    import pyspark3.ml.classification
