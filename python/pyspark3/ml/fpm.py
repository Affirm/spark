...
from pyspark3.ml.util import JavaMLWritable, JavaMLReadable
from pyspark3.ml.wrapper import JavaEstimator, JavaModel, JavaParams
from pyspark3.ml.param.shared import HasPredictionCol, Param, TypeConverters, Params
...
class FPGrowth(JavaEstimator, _FPGrowthParams, JavaMLWritable, JavaMLReadable):
    ...
    Examples
    --------
    >>> from pyspark3.sql.functions import split
    >>> data = (spark.read
...
class PrefixSpan(JavaParams):
    ...
    Examples
    --------
    >>> from pyspark3.ml.fpm import PrefixSpan
