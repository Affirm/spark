...
from pyspark3.ml.param.shared import HasMaxIter, HasFeaturesCol, HasSeed, HasPredictionCol, \
...
from pyspark3.ml.util import JavaMLWritable, JavaMLReadable, GeneralJavaMLWritable, \
    HasTrainingSummary, SparkContext
from pyspark3.ml.wrapper import JavaEstimator, JavaModel, JavaParams, JavaWrapper
from pyspark3.ml.common import inherit_doc, _java2py
from pyspark3.ml.stat import MultivariateGaussian
...
class LDA(JavaEstimator, _LDAParams, JavaMLReadable, JavaMLWritable):
    ...
    Examples
    --------
    >>> from pyspark3.ml.linalg import Vectors, SparseVector
    >>> from pyspark3.ml.clustering import LDA
