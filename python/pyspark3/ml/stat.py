...
from pyspark3.ml.common import _java2py, _py2java
from pyspark3.ml.wrapper import JavaWrapper, _jvm
from pyspark3.sql.column import Column, _to_seq
...
class ChiSquareTest(object):
    ...
    def test(dataset, featuresCol, labelCol, flatten=False):
        ...
        >>> from pyspark3.ml.stat import ChiSquareTest
...
class Correlation(object):
    ...
    def corr(dataset, column, method="pearson"):
        ...
        Examples
        --------
        >>> from pyspark3.ml.linalg import DenseMatrix, Vectors
        >>> from pyspark3.ml.stat import Correlation
...
class KolmogorovSmirnovTest(object):
    ...
    def test(dataset, sampleCol, distName, *params):
        ...
        Examples
        --------
        >>> from pyspark3.ml.stat import KolmogorovSmirnovTest
        >>> dataset = [[-1.0], [0.0], [1.0]]
...
class Summarizer(object):
    ...
    Examples
    --------
    >>> from pyspark3.ml.stat import Summarizer
