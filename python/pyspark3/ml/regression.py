...
from pyspark3 import keyword_only, since
from pyspark3.ml import Predictor, PredictionModel
from pyspark3.ml.base import _PredictorParams
from pyspark3.ml.param.shared import HasFeaturesCol, HasLabelCol, HasPredictionCol, HasWeightCol, \
...
from pyspark3.ml.util import JavaMLWritable, JavaMLReadable, HasTrainingSummary, \
    GeneralJavaMLWritable
from pyspark3.ml.wrapper import JavaEstimator, JavaModel, \
...
class FMRegressor(_JavaRegressor, _FactorizationMachinesParams, JavaMLWritable, JavaMLReadable):
    ...
    * adamW (default)
    ...
    --------
    >>> from pyspark3.ml.linalg import Vectors
    >>> from pyspark3.ml.regression import FMRegressor
    >>> df = spark.createDataFrame([
