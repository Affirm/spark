...
from pyspark3 import since, keyword_only, SparkContext
from pyspark3.ml.linalg import _convert_to_vector
from pyspark3.ml.param.shared import HasThreshold, HasThresholds, HasInputCol, HasOutputCol, \
...
from pyspark3.ml.util import JavaMLReadable, JavaMLWritable
from pyspark3.ml.wrapper import JavaEstimator, JavaModel, JavaParams, JavaTransformer, _jvm
...
class IDF(JavaEstimator, _IDFParams, JavaMLReadable, JavaMLWritable):
    ...
    Examples
    --------
    >>> from pyspark3.ml.linalg import DenseVector
...
class Word2Vec(JavaEstimator, _Word2VecParams, JavaMLReadable, JavaMLWritable):
    ...
    >>> from pyspark3.sql.functions import format_number as fmt
...
class VectorSizeHint(JavaTransformer, HasInputCol, HasHandleInvalid, JavaMLReadable,
    ...
    --------
    >>> from pyspark3.ml.linalg import Vectors
    >>> from pyspark3.ml import Pipeline, PipelineModel
