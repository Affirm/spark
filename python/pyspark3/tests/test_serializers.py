...
from pyspark3 import serializers
from pyspark3.serializers import CloudPickleSerializer, CompressedSerializer, \
    ...
    MarshalSerializer
from pyspark3.testing.utils import PySparkTestCase, read_int, write_int, ByteArrayOutput, \
...
class SerializationTestCase(unittest.TestCase):
    ...
    def test_namedtuple(self):
        ...
        from pyspark3.cloudpickle import dumps
        P2 = loads(dumps(P))
        p3 = P2(1, 3)
...
if __name__ == "__main__":
    from pyspark3.tests.test_serializers import *  # noqa: F401
