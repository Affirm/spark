...
from pyspark3.testing.utils import ReusedPySparkTestCase, PySparkTestCase, QuietTest
...
class WorkerTests(ReusedPySparkTestCase):
    ...
    def test_accumulator_when_reuse_worker(self):
        from pyspark3.accumulators import INT_ACCUMULATOR_PARAM
...
if __name__ == "__main__":
    import unittest
    from pyspark3.tests.test_worker import *  # noqa: F401
