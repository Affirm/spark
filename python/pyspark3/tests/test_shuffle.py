...
from pyspark3 import shuffle, PickleSerializer, SparkConf, SparkContext
from pyspark3.shuffle import Aggregator, ExternalMerger, ExternalSorter
...
if __name__ == "__main__":
    from pyspark3.tests.test_shuffle import *  # noqa: F401
