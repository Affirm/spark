...
from pyspark3 import SparkContext, since
from pyspark3.rdd import RDD
from pyspark3.mllib.common import JavaModelWrapper, callMLlibFunc, callJavaFunc, _py2java, _java2py
from pyspark3.mllib.linalg import SparseVector, _convert_to_vector, DenseVector  # noqa: F401
from pyspark3.mllib.stat.distribution import MultivariateGaussian
from pyspark3.mllib.util import Saveable, Loader, inherit_doc, JavaLoader, JavaSaveable
from pyspark3.streaming import DStream
...
class GaussianMixtureModel(JavaModelWrapper, JavaSaveable, JavaLoader):
    ...
    Examples
    --------
    >>> from pyspark3.mllib.linalg import Vectors, DenseMatrix
...
class LDAModel(JavaModelWrapper, JavaSaveable, Loader):
    ...
    Examples
    --------
    >>> from pyspark3.mllib.linalg import Vectors
...
def _test():
    import doctest
    import numpy
    import pyspark3.mllib.clustering
    try:
