...
from pyspark3.streaming.dstream import DStream
from pyspark3.mllib.common import callMLlibFunc, _py2java, _java2py, inherit_doc
from pyspark3.mllib.linalg import _convert_to_vector
from pyspark3.mllib.util import Saveable, Loader
...
def _regression_train_wrapper(train_func, modelClass, data, initial_weights):
    from pyspark3.mllib.classification import LogisticRegressionModel
    first = data.first()
...
def _test():
    ...
    import pyspark3.mllib.regression
