...
from pyspark3.mllib.fpm import FPGrowth
from pyspark3.mllib.recommendation import Rating
from pyspark3.mllib.regression import LabeledPoint
from pyspark3.serializers import PickleSerializer
from pyspark3.testing.mllibutils import MLlibTestCase
...
class ListTests(MLlibTestCase):
    ...
    def test_bisecting_kmeans(self):
        from pyspark3.mllib.clustering import BisectingKMeans
    ...
    def test_kmeans(self):
        from pyspark3.mllib.clustering import KMeans
        data = [
            [0, 1.1],
            [0, 1.2],
            [1.1, 0],
    ...
    def test_gmm(self):
        from pyspark3.mllib.clustering import GaussianMixture
    ...
    def test_classification(self):
        from pyspark3.mllib.classification import LogisticRegressionWithSGD, SVMWithSGD, NaiveBayes
        from pyspark3.mllib.tree import DecisionTree, DecisionTreeModel, RandomForest, \
    ...
    def test_regression(self):
        from pyspark3.mllib.regression import LinearRegressionWithSGD, LassoWithSGD, \
            RidgeRegressionWithSGD
        from pyspark3.mllib.tree import DecisionTree, RandomForest, GradientBoostedTrees
        data = [
...
if __name__ == "__main__":
    from pyspark3.mllib.tests.test_algorithms import *  # noqa: F401
