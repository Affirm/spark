...
from pyspark3 import RDD, since
from pyspark3.mllib.common import callMLlibFunc, inherit_doc, JavaModelWrapper
from pyspark3.mllib.linalg import _convert_to_vector
from pyspark3.mllib.regression import LabeledPoint
from pyspark3.mllib.util import JavaLoader, JavaSaveable
...
class DecisionTree(object):
    ...
    def trainRegressor(cls, data, categoricalFeaturesInfo,
        ...
        >>> from pyspark3.mllib.regression import LabeledPoint
        >>> from pyspark3.mllib.tree import DecisionTree
        >>> from pyspark3.mllib.linalg import SparseVector
        >>>
        >>> sparse_data = [
...
class RandomForest(object):
    ...
    def trainClassifier(cls, data, numClasses, categoricalFeaturesInfo, numTrees,
        ...
        --------
        >>> from pyspark3.mllib.regression import LabeledPoint
        >>> from pyspark3.mllib.tree import RandomForest
        >>>
        >>> data = [
        ...     LabeledPoint(0.0, [0.0]),
...
class GradientBoostedTrees(object):
    ...
    def trainClassifier(cls, data, categoricalFeaturesInfo,
        ...
        --------
        >>> from pyspark3.mllib.regression import LabeledPoint
        >>> from pyspark3.mllib.tree import GradientBoostedTrees
        >>>
        >>> data = [
        ...     LabeledPoint(0.0, [0.0]),
        ...     LabeledPoint(0.0, [1.0]),
