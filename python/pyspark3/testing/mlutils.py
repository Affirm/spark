...
from pyspark3.ml import Estimator, Model, Transformer, UnaryTransformer
from pyspark3.ml.evaluation import Evaluator
from pyspark3.ml.param import Param, Params, TypeConverters
from pyspark3.ml.param.shared import HasMaxIter, HasRegParam
from pyspark3.ml.classification import Classifier, ClassificationModel
from pyspark3.ml.util import DefaultParamsReadable, DefaultParamsWritable
from pyspark3.ml.wrapper import _java2py  # type: ignore
from pyspark3.sql import DataFrame, SparkSession
from pyspark3.sql.types import DoubleType
from pyspark3.testing.utils import ReusedPySparkTestCase as PySparkTestCase
...
class DummyLogisticRegressionModel(ClassificationModel, _DummyLogisticRegressionParams,
    ...
    def _transform(self, dataset):
        ...
        from pyspark3.sql.functions import array, lit
        from pyspark3.ml.functions import array_to_vector
